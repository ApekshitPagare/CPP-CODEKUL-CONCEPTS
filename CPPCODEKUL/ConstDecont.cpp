/*USE DEFAULT,PARAMETRISED,COPY CONSTRUCTOR AND DECONSTRUCTOR FOR VALUES SENT BY OBJECTS*/
/*CREATE A SQUARE FUNCTION AND SEND AN VALUE THROUGH OBJECT AND DISPLAY ITS SQUARE*/
...
int main() {
	...
	obj1.display();
    	...
    	cout<<"\nSquare: "<<obj2.square_a()<<endl;/*Object2's a=10 will be sent to member function 'int square_a()' and its square 'b' will
						  be returned to main function to display*/
