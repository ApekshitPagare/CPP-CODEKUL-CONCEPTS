/*Using Simple Inheritance using 'this' pointer and using setters and getters*/
/*Create a class Employee and store id,salary,raise and do increment using function*/
#include<iostream>
using namespace std;
...
void Employee :: display() {
    cout<<"Id: "<<get_id()<<endl<<"Salary: "<<get_salary()<<endl;
}
